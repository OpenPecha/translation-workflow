...
def get_multilevel_translation_prompt(source_text, multilevel_summary, word_by_word_translation, ucca_analysis, target_language="English"):
    """
    Generate a prompt for creating translations using multilevel summary, word-by-word translation, and UCCA analysis.
    
    Args:
        source_text: The original source text to translate
        multilevel_summary: Hierarchical summary/analysis of the text
        word_by_word_translation: Word-by-word or glossary-style translation
...
- Use the WORD-BY-WORD TRANSLATION for precise lexical choices and technical term accuracy
